...
const K = {
  ...
  cursorCliPath: 'ai-assistant.cursorCli.path',
...
export const AIConfig = {
  ...
  getProvider: () => get<'api' | 'claude-cli' | 'cursor-cli'>(K.provider, 'api'),
  ...
  getCursorCliPath: () => String(get(K.cursorCliPath, 'agent')).trim() || 'agent',
